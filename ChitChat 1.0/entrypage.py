...
def add_account(username, password):
    ...
    if username in df["username"].values:
        ...
        # generating RSA keys
        n1, e1, d1 = rsa.generate_keypair(10)
        n2, e2, d2 = rsa.generate_keypair(10)
        n3, e3, d3 = rsa.generate_keypair(10)
        n4, e4, d4 = rsa.generate_keypair(10)
        n5, e5, d5 = rsa.generate_keypair(10)
        ...
        filename = "client_side/encryptionkeys/" + username + ".txt"

        # storing encryption keys
        with open(filename, "w") as file:
            file.write(f"{n1}, {e1}, {d1}\n")
            file.write(f"{n2}, {e2}, {d2}\n")
            file.write(f"{n3}, {e3}, {d3}\n")
            file.write(f"{n4}, {e4}, {d4}\n")
            file.write(f"{n5}, {e5}, {d5}\n")
